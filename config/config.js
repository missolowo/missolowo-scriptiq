...
const CONFIG = {
  ...
  // Pricing (in Kobo)
  PLANS: {
    free: { name: 'Free', price: 0, credits: 3, currency: 'NGN' },
    starter: { name: 'Starter', price: 250000, credits: 80, currency: 'NGN' },
    pro: { name: 'Pro', price: 800000, credits: 300, currency: 'NGN' }
  },
